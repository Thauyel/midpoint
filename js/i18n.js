...
const TRANSLATIONS = {
  tr: {
    ...
    "hint.done":     "yerler adalet ve orta noktaya yakınlığa göre listelendi.",
    ...
    "sort.midpoint": "en adil ve ortaya yakın",
    "sort.fair":     "en adil",
  ...
  en: {
    ...
    "hint.done":     "places ranked by fairness & closeness.",
